...
**Parameters**:
- `struct lps *nlps`: Pointer to the `lps` object to initialize.
...
**Parameters**:
- `struct lps *nlps`: Pointer to the `lps` object to free.
...
**Parameters**:
- `struct lps *nlps`: Pointer to the `lps` object to write.
